...
export const updateNotificationItemIsExpandedById = createAction(NotificationActionType.UPDATE_NOTIFICATION_ITEM_IS_EXPANDED, props<{notificationItemId: number}>())